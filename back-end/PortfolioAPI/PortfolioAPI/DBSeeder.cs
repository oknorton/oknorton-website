    ...
    public static class DBSeeder
    {
        public static void Initialize(PortfolioDbContext context)
        {
            ...
            var projects = new List<Project>
            {
                ...
                {
                    Title = "Zazu",
                    Description = "A platform focused at increasing stakeholder improvement for better results.",
                ...
                {
                    Title = "Boebot",
                    Description = "An autonomous robot system capable of object detection, mobility, and remote controlled input",
                ...
                new Project
                {
                    ...
                    Description = "A remote client server health management system allowing medical professionals to monitor a patient's vitals from a remote location",
                ...
                new Project
                {
                    ...
                    Description = "A dynamic portfolio website to showcase experience, contact and personal information about Oliver Norton",
                ...
                new Project
                {
                    ...
                    ImageURL = "https://www.schoolofsciencery.com/wp-content/uploads/2023/02/Project-Management-Post.jpg",
                    Date = DateTime.Now.AddDays(-9),
                    ProjectTags = new List<ProjectTag>
                    {
                        new ProjectTag { TagId = tags[1].Id }, 
